    ...
    <div class="profile-card">
        ...
        <div class="profile-body">
            ...
            <div class="profile-info">
                ...
                <div class="info-group">
                    ...
                    <div class="info-value">
                        <span class="badge-type badge-admin">
                            @if($user->type === 'admin')
                                Administrateur
                            @elseif($user->type === 'enseignant')
                                Enseignant
            ...
            <div class="action-buttons">
                <a href="{{ route('admin.account.editNomPrenom', $user->id) }}" class="btn-profile btn-edit">
                    <i class="bi bi-pencil me-2"></i>Modifier Mes Informations
                </a>
                <a href="{{ route('admin.account.edit') }}" class="btn-profile btn-changepwd">
